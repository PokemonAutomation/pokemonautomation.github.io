...
3. [Y-Comm glitch](DateSpam-YCommGlitch.md) must be active
    ...
    2. NOTE: Activating the Y-Comm glitch requires you to have Nintendo Switch Online (NSO), or SwSh on multiple Switches. If you don't have this, uncheck "I have Nintendo Switch Online" in the Computer Control program and the program will not require the Y-Comm glitch. However, farming Watts is much slower without using the Y-Comm glitch.
