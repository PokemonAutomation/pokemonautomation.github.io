...
This program is useful for activating the [Y-Comm glitch](DateSpam-YCommGlitch.md) while playing on the computer or remotely. This is because:
...
To activate [Y-Comm glitch](DateSpam-YCommGlitch.md) using this program:
