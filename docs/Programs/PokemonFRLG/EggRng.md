...
- *Optional, but recommended*: Have a Pokémon that knows Rock Smash in your party.
    - Krabby and Gyarados are easily-obtainable Pokémon that can learn both Surf and Rock Smash
...
When checked, the boulder on the beach will be smashed to prevent RNG noise. This can prevent swings of several RNG advances during calibration and help the program hit the target pickup frame more quickly, but requires a Pokémon with Rock Smash in your party. 
