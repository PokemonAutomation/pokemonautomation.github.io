...
This shows the species, level, gender, nature, and IVs of your target based on the Target Settings entered below. Use this to check whether or not you've entered the correct target seed and advances.
...
All RNG methods are checked during calibration regardless of this setting. The most likely method for your encounter can be determined by [finding the number of PID rerolls](https://mucksw.github.io/PID-Reroll-Calculator/) and referencing the plot [here](https://docs.google.com/spreadsheets/d/1hCZznFa4cez3l2qx1DmYPbuB_dNGTqqCoaksZf-Q44s/edit?resourcekey=&gid=1588241733#gid=1588241733).
...
If checked, the program will open the Teachy TV to quickly advance the RNG at 313x speed. Make sure that the Teachy TV is at the top position of the bag.
